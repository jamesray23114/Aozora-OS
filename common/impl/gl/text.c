...
const byte letters[95][10] = // TODO: impliment lowercase letters
{
    { //
        0b00000000,        
        0b00000000,
...
void gl_putc(char c)
{
    ...
    switch(c)
    {
        ...
        default:
            ...
            gl_drawMask(cur_x++ * CHARWIDTH, cur_y * CHARHEIGHT + 2, 1, 10, 0xffffffff, letters[c - 32]);
            return;
    }
}
